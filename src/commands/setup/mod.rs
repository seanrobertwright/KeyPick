...
fn run_full_wizard(walkthrough: bool) {
    ...
    if walkthrough {
        utils::explain(&[
            ...
            "     and create an empty encrypted vault.",
    ...
    if walkthrough {
        utils::explain(&[
            ...
            "",
            "NEXT STEPS:",
            "  1. cd into your vault repo directory",
            "  2. Run `keypick add` to store your first API keys",
            "  3. Run `keypick extract` in a project directory to create a .env file",
            "  4. On another machine, run `keypick setup` and choose 'Join existing vault'",
            "",
